...
import static ro.server.KernelImpl.ISO88591;
import static ro.server.KernelImpl.createCouchConnection;
import static ro.server.KernelImpl.fetchJsonByIdVisitor;
import static ro.server.KernelImpl.getRevision;
import static ro.server.KernelImpl.moveCaretToDoubleEol;
import static ro.server.KernelImpl.recycleChannel;
import static ro.server.KernelImpl.sortableInetAddress;
