...
var IdbPouch = function(opts, callback) {
  ...
  req.onsuccess = function(e) {
    ...
    req.onsuccess = function(e) {
      ...
      // detect blob support
      try {
        txn.objectStore(DETECT_BLOB_SUPPORT_STORE).put(new Blob(), "id");
        blobSupport = true;
      } catch (err) {
        blobSupport = false;
      } finally {
  ...
  api._allDocs = function idb_allDocs(opts, callback) {
    ...
    oCursor.onsuccess = function(e) {
      ...
      // id in opts.keys. With no performance tests it is difficult to
...
var MapReduce = function(db) {
    ...
    var builtInReduce = {
      ...
      "_stats": function(keys, values, rereduce) {
        return {
          ...
          'sumsqr': (function(){
            var _sumsqr = 0;
            for(var idx in values) if (typeof values[idx] === 'number') {
  ...
  function httpQuery(fun, opts, callback) {
    ...
    if (typeof opts.key !== 'undefined') {
      params.push('id=' + encodeURIComponent(JSON.stringify(opts.key)));
    }
