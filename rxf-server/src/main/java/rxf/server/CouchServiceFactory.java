...
public class CouchServiceFactory {
	...
	private static class CouchServiceHandler<E>
			implements
				InvocationHandler,
				CouchNamespace<E> {
		AtomicReference<Map<String, String>> viewMethods = new AtomicReference<Map<String, String>>(
				new TreeMap<String, String>());
		private Future init;
		Class<E> entityType;

		public CouchServiceHandler(Class<?> serviceInterface, String... ns)
		...
		void init(final Class<?> serviceInterface, final String... initNs)
				throws ExecutionException, InterruptedException {
			...
			init = RelaxFactoryServer.App.get().getEXECUTOR_SERVICE().submit(
					new Callable() {
		...
		public Object invoke(Object proxy, final Method method,
			...
			if (viewMethods.get().containsKey(method.getName())) {
				return RelaxFactoryServer.App.get().getEXECUTOR_SERVICE()
						.submit(new Callable() {
							public Object call() throws Exception {
