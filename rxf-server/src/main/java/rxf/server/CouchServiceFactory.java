      ...
      init = EXECUTOR_SERVICE.submit(new Callable<Object>() {
        public Object call() throws Exception {
          try {
            ...
            final Rfc822HeaderState etag1 = new Rfc822HeaderState(ETAG);
            final CouchTx tx = new getRevisionBuilder().db(pathPrefix).docId(id).to().state(etag1).fire().tx();
    ...
    public Object invoke(Object proxy, final Method method, final Object[] args) throws ExecutionException, InterruptedException {
      ...
      return EXECUTOR_SERVICE.submit(new Callable() {
        public Object call() throws Exception {
          ...
          final Class<?> entityType1 = CouchServiceHandler.this.entityType;
          if (viewMethods.containsKey(name)) {
            ...
            final Class<?> entityType11 = entityType1;
            ArrayList ar = new ArrayList();
            for (Object row : rows.rows) {
              final Object value = ((tuple) row).value;
