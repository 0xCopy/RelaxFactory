...
public class CouchChangesClient extends AsioVisitor.Impl{
  ...
  public String                hostname          =RelaxFactoryServer.App.get().getLOOPBACK().getHostAddress();
  ...
  public String getFeedString(){
    return "/"+feedname+"/_changes?include_docs=true&feed=continuous&heartbeat="+POLL_HEARTBEAT_MS;
  }
