...
public interface CouchDriver{
  ...
  Gson     GSON                     =new GsonBuilder().setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").setFieldNamingPolicy(
  ...
  java.nio.ByteBuffer BlobSend(java.nio.ByteBuffer blob,java.lang.String db,java.lang.String docId,java.lang.String rev,
          ...
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.DbCreate.visit()).toString(),CouchTx.class);
            }catch(Exception e){
      ...
      public DbDeleteTerminalBuilder fire(){
        return new DbDeleteTerminalBuilder(){
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.DbDelete.visit()).toString(),CouchTx.class);
            }catch(Exception e){
              if(RelaxFactoryServer.App.get().isDEBUG_SENDJSON())
                e.printStackTrace();
            }
            ...
            try{
              RelaxFactoryServer.App.get().getEXECUTOR_SERVICE().submit(new Callable<ByteBuffer>(){
                ...
                public java.nio.ByteBuffer call() throws Exception{
                  DbKeysBuilder.currentKeys.set(dbKeysBuilder);
                  ActionBuilder.currentAction.set(actionBuilder);
                  return (java.nio.ByteBuffer)rxf.server.driver.CouchMetaDriver.RevisionFetch.visit(dbKeysBuilder,
                      actionBuilder);
                }
              });
            }catch(Exception e){
      ...
      public DocPersistTerminalBuilder fire(){
        return new DocPersistTerminalBuilder(){
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.DocPersist.visit()).toString(),CouchTx.class);
            }catch(Exception e){
              if(RelaxFactoryServer.App.get().isDEBUG_SENDJSON())
                e.printStackTrace();
            }
      ...
      public DocDeleteTerminalBuilder fire(){
        return new DocDeleteTerminalBuilder(){
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.DocDelete.visit()).toString(),CouchTx.class);
            }catch(Exception e){
              if(RelaxFactoryServer.App.get().isDEBUG_SENDJSON())
                e.printStackTrace();
            }
            ...
            try{
              RelaxFactoryServer.App.get().getEXECUTOR_SERVICE().submit(new Callable<ByteBuffer>(){
                ...
                public java.nio.ByteBuffer call() throws Exception{
                  DbKeysBuilder.currentKeys.set(dbKeysBuilder);
                  ActionBuilder.currentAction.set(actionBuilder);
                  return (java.nio.ByteBuffer)rxf.server.driver.CouchMetaDriver.DesignDocFetch.visit(dbKeysBuilder,
                      actionBuilder);
                }
              });
            }catch(Exception e){
      ...
      public ViewFetchTerminalBuilder fire(){
        return new ViewFetchTerminalBuilder(){
          public rxf.server.CouchResultSet rows(){
            try{
              return GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  avoidStarvation(rxf.server.driver.CouchMetaDriver.ViewFetch.visit())).toString(),
      ...
      public JsonSendTerminalBuilder fire(){
        return new JsonSendTerminalBuilder(){
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.JsonSend.visit()).toString(),CouchTx.class);
            }catch(Exception e){
              if(RelaxFactoryServer.App.get().isDEBUG_SENDJSON())
                e.printStackTrace();
            }
          ...
          public rxf.server.CouchResultSet rows(){
            try{
              return GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  avoidStarvation(rxf.server.driver.CouchMetaDriver.JsonSend.visit())).toString(),
                  new java.lang.reflect.ParameterizedType(){
                    public Type getRawType(){
                      return CouchResultSet.class;
                    }
  ...
  class BlobSend extends DbKeysBuilder{
      ...
      public BlobSendTerminalBuilder fire(){
        return new BlobSendTerminalBuilder(){
          public CouchTx tx(){
            try{
              return (CouchTx)GSON.fromJson(rxf.server.RelaxFactoryServer.UTF8.decode(
                  rxf.server.driver.CouchMetaDriver.BlobSend.visit()).toString(),CouchTx.class);
            }catch(Exception e){
              if(RelaxFactoryServer.App.get().isDEBUG_SENDJSON())
                e.printStackTrace();
            }
            ...
            try{
              RelaxFactoryServer.App.get().getEXECUTOR_SERVICE().submit(new Callable<ByteBuffer>(){
                ...
                public java.nio.ByteBuffer call() throws Exception{
                  DbKeysBuilder.currentKeys.set(dbKeysBuilder);
                  ActionBuilder.currentAction.set(actionBuilder);
                  return (java.nio.ByteBuffer)rxf.server.driver.CouchMetaDriver.BlobSend.visit(dbKeysBuilder,actionBuilder);
                }
              });
            }catch(Exception e){
              e.printStackTrace();
            ...
            RelaxFactoryServer.App.get().getEXECUTOR_SERVICE().submit(new Runnable(){
              public void run(){
                try{
                  ...
                  DbKeysBuilder.currentKeys.set(dbKeysBuilder);
                  ActionBuilder.currentAction.set(actionBuilder);
                  rxf.server.driver.CouchMetaDriver.BlobSend.visit();
                }catch(Exception e){
                  e.printStackTrace();
                }
              }
    ...
    public BlobSendActionBuilder to(){
      ...
      throw new IllegalArgumentException("required parameters are: [blob, db, docId, rev, attachname]");
    }
