...
public DbCreate  validjson(java.lang.String stringParam){parms.put(DbKeys.etype.validjson,stringParam);return this;}
...
public class ViewFetch<T> extends DbKeysBuilder<rxf.server.CouchResultSet<T>> {
  ...
  static public <T extends java.lang.Object> ViewFetch<T> $() {
    return new ViewFetch<T>();
  }

  public interface ViewFetchTerminalBuilder<T> extends TerminalBuilder<rxf.server.CouchResultSet<T>> {
    rxf.server.CouchResultSet<T> rows();Future<rxf.server.CouchResultSet<T>>future(); void continuousFeed();

  }

  public class ViewFetchActionBuilder extends ActionBuilder<rxf.server.CouchResultSet<T>> {
    public ViewFetchActionBuilder( /*<rxf.server.CouchResultSet<T>>*/ ) {
      super(/*synchronousQueues*/);
    }
    ...
    public ViewFetchTerminalBuilder<T> fire() {
      return new ViewFetchTerminalBuilder<T>() {
         public rxf.server.CouchResultSet<T> rows(){ 
try {
        return (rxf.server.CouchResultSet<T>)  BlobAntiPatternObject.GSON.fromJson( (String)rxf.server.CouchMetaDriver.ViewFetch.visit(),new java.lang.reflect.ParameterizedType() {public java.lang.reflect.Type getRawType() {return rxf.server.CouchResultSet.class;}public java.lang.reflect.Type getOwnerType() {return null;}public java.lang.reflect.Type[] getActualTypeArguments() {return new java.lang.reflect.Type[]{(Class)parms().get(DbKeys.etype.type)};}});
      } catch (Exception e) {
        e.printStackTrace();    
      }         
...
public rxf.server.CouchResultSet<T> call()throws Exception{ 
                    ...
                    DbKeysBuilder.currentKeys.set(dbKeysBuilder);  
 ActionBuilder.currentAction.set(actionBuilder);  return(rxf.server.CouchResultSet<T>)rxf.server.CouchMetaDriver.ViewFetch.visit(dbKeysBuilder,actionBuilder);}});
...
static private final int parmsCount=2;
public ViewFetch<T>  db(java.lang.String stringParam){parms.put(DbKeys.etype.db,stringParam);return this;}
public ViewFetch<T>  view(java.lang.String stringParam){parms.put(DbKeys.etype.view,stringParam);return this;}
public ViewFetch<T>  type(java.lang.Class classParam){parms.put(DbKeys.etype.type,classParam);return this;}
...
public class JsonSend extends DbKeysBuilder<rxf.server.CouchTx> {
  ...
  public interface JsonSendTerminalBuilder extends TerminalBuilder<rxf.server.CouchTx> {
     CouchTx tx();void oneWay();rxf.server.CouchTx rows();Future<rxf.server.CouchTx>future(); void continuousFeed();
...
} public rxf.server.CouchTx rows(){ 
try {
        return (rxf.server.CouchTx)  BlobAntiPatternObject.GSON.fromJson( (String)rxf.server.CouchMetaDriver.JsonSend.visit(),new java.lang.reflect.ParameterizedType() {public java.lang.reflect.Type getRawType() {return rxf.server.CouchTx.class;}public java.lang.reflect.Type getOwnerType() {return null;}public java.lang.reflect.Type[] getActualTypeArguments() {return new java.lang.reflect.Type[]{(Class)parms().get(DbKeys.etype.type)};}});
      } catch (Exception e) {
        e.printStackTrace();    
      }         
...
public BlobSend  db(java.lang.String stringParam){parms.put(DbKeys.etype.db,stringParam);return this;}
public BlobSend  docId(java.lang.String stringParam){parms.put(DbKeys.etype.docId,stringParam);return this;}
public BlobSend  opaque(java.lang.String stringParam){parms.put(DbKeys.etype.opaque,stringParam);return this;}
public BlobSend  mimetype(java.lang.String stringParam){parms.put(DbKeys.etype.mimetype,stringParam);return this;}
public BlobSend  blob(java.nio.ByteBuffer bytebufferParam){parms.put(DbKeys.etype.blob,bytebufferParam);return this;}
