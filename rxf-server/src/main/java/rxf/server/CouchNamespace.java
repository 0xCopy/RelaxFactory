...
public interface CouchNamespace<T>{
  ...
  String                                             COUCH_DEFAULT_FS_ROOT              =null==System
                                                                                            .getenv(RXF_SERVER_CONTENT_ROOT_ENV_KEY)?System
                                                                                            .getProperty(
                                                                                                RXF_SERVER_CONTENT_ROOT_SYSTEM_KEY,
                                                                                                "./")
                                                                                            :System
   ...
   */
  String                                             COUCH_DEFAULT_ORGNAME              =null==System
                                                                                            .getenv(RXF_ORGNAME_ENV_KEY)?System
                                                                                            .getProperty(
                                                                                                RXF_ORGNAME_SYSTEM_KEY,"rxf_")
                                                                                            :System
                                                                                                .getenv(RXF_ORGNAME_ENV_KEY)
                                                                                                .toLowerCase().trim();
