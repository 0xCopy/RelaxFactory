...
public class InjectedTopLevelVisitor extends AsioVisitor.Impl {
    private final Map<HttpMethod, Map<String, Key<? extends AsioVisitor>>> bindings = new EnumMap<>(HttpMethod.class);
            ...
            public void onRead(SelectionKey key) throws Exception {
                ...
                try {
                    ...
                    if (RelaxFactoryServer.App.get().isDEBUG_SENDJSON()) {
                        System.err.println(BlobAntiPatternRelic.deepToString(UTF8.decode((ByteBuffer) httpRequest.headerBuf().duplicate().rewind())));
                    }
                ...
                System.err.println(BlobAntiPatternRelic.deepToString("!!!1!1!!", "404", path, "using", NAMESPACE));
            }
        });
