...
public class DateHeaderParserTest {
  Map<String, String> map = new HashMap() {
    {
      ...
      put("'Sun, 1 Nov 1994 08:49:37 GMT'", "Tue Nov 01 00:49:37 PST 1994"); //  ; RFC 822, updated by RFC 1123
      //      put("'Sun November  1 08:49:37 1994 '", "Tue Nov 01 08:49:37 GMT 1994"); //   ; ANSI C's asctime() format
  ...
  public void testIfModifiedStuff() {
    ...
    for (Map.Entry<String, String> stringStringEntry : map.entrySet()) {
      ...
      assertEquals(date.toGMTString(), new Date(stringStringEntry.getValue()).toGMTString());
