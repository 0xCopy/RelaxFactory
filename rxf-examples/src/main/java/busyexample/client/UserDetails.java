...
import static busyexample.client.Welcome.gather;
import static busyexample.client.Welcome.requestFactory;
      ...
      addClickHandler(new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
          ...
          requestFactory.couch().setSessionProperty(key, text).fire(new Receiver<String>() {
            ...
            @Override
            public void onSuccess(String ver) {
