...
public class DealEditorWidget implements DealEditorView {
  ...
  @UiField TextBox product;
  
  @UiField TextArea productDescription;
  
  @UiField IntegerBox limit;
  
  @UiField DateBox expire;
  ...
  @UiField(provided = true) ValueListBox<VendorProxy> vendor;
  @UiField(provided = true) ValueListBox<NpoProxy> npo;
